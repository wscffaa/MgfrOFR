...
#
# 用法示例：
#   OFR_EXT_PATH=ofr_projects/rrtn_wavelet python train.py -opt options/train/rrtn_wavelet/rrtn_wavelet.yml
#   OFR_EXT_PATH=ofr_projects/a:ofr_projects/b python train.py -opt ...
#
...
def _prepend_ofr_ext_paths(root_path: str) -> None:
    ...
    # 支持项目依赖：ofr_projects/<project>/ofr_deps.txt
...
# Fix: ensure repo root in sys.path for projects/ imports (e.g. 001-reidmamba)
_repo_root = osp.dirname(ROOT_PATH)
...
from basicsr.train import train_pipeline  # noqa: E402


if __name__ == '__main__':
    train_pipeline(WORKSPACE_PATH)
