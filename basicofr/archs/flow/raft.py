...
Merged single-file implementation for inference only.
"""
import torch
...
def bilinear_sampler(img, coords, mode='bilinear', mask=False):
    ...
    # Disable cuDNN for grid_sample to avoid CUDNN_STATUS_NOT_SUPPORTED error
    ...
    def __init__(self, in_planes, planes, norm_fn='group', stride=1):
        ...
        if stride == 1:
            ...
            self.downsample = nn.Sequential(
                nn.Conv2d(in_planes, planes, kernel_size=1, stride=stride), self.norm1)
